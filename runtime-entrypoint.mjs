...
const targets = Object.freeze({
  ...
  "customer-worker": "/app/apps/api/dist/temporal/worker.js",
  "platform-worker": "/app/apps/api/dist/temporal/platform-worker.js",
});

const command = process.argv[2];
if (!command || !(command in targets)) {
  throw new Error(
    "runtime entrypoint must be exactly api, customer-worker or platform-worker",
  );
}
