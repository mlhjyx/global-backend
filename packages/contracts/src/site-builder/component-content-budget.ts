...
export const QUALIFIED_COMPONENT_CONTENT_BUDGETS = Object.freeze({
  ...
  MediaCta: Object.freeze({ eyebrow: 40, title: 80, titleWords: 12, accent: 40, sub: 240, cta: 24 }),
  FarmhouseHero: Object.freeze({ eyebrow: 40, title: 80, titleWords: 12, cta: 24, scroll: 48 }),
  FeaturedSpotlight: Object.freeze({ eyebrow: 40, title: 80, titleWords: 12, minItems: 0, maxItems: 8, name: 80, category: 48, price: 24, cta: 24 }),
  StoryChapters: Object.freeze({ eyebrow: 40, title: 80, titleWords: 12, minItems: 0, maxItems: 8, chapterEyebrow: 40, chapterTitle: 80, body: 400 }),
  ChapterShowcase: Object.freeze({ chapter: 40, title: 80, titleWords: 12, minItems: 0, maxItems: 8, tag: 48, name: 80, spec: 48 }),
  DispatchHero: Object.freeze({ file: 48, chapter: 48, eyebrow: 48, title: 80, titleWords: 12, body: 240, cta: 24, phone: 24, trust: 80, label: 48, value: 48, minAreas: 2, maxAreas: 12, area: 80 }),
  ServicesEditorial: Object.freeze({ chapter: 48, title: 80, titleWords: 12, minItems: 1, maxItems: 8, code: 24, serviceTitle: 80, body: 240, spec: 80, cta: 24, asideLabel: 48, aside: 240, asideCta: 24 }),
  DispatchTimeline: Object.freeze({ chapter: 48, title: 80, titleWords: 12, accent: 40, body: 240, cta: 24, call: 40, minItems: 1, maxItems: 8, time: 24, stepTitle: 80, stepBody: 240 }),
  CrewGrid: Object.freeze({ chapter: 48, title: 80, titleWords: 12, body: 240, minStats: 1, maxStats: 4, label: 48, value: 24, sub: 80, minMembers: 1, maxMembers: 8, name: 80, role: 80, years: 24, regions: 120, quote: 240, truck: 48, cta: 24, footnote: 160 }),
...
const contentSchemas = {
  ...
  MediaCta: z.object({eyebrow:boundedCopy(40),title:boundedCopy(80,12),accent:boundedCopy(40),sub:boundedCopy(240),primaryCta:boundedCopy(24,4),secondaryCta:boundedCopy(24,4).optional(),whatsapp:boundedCopy(24,4).optional()}).strict(),
  FarmhouseHero: z.object({eyebrow:boundedCopy(40),title:boundedCopy(80,12),primaryCta:boundedCopy(24,4),secondaryCta:boundedCopy(24,4).optional(),scroll:boundedCopy(48)}).strict(),
  FeaturedSpotlight: z.object({eyebrow:boundedCopy(40),title:boundedCopy(80,12),items:z.array(z.object({name:boundedCopy(80),category:boundedCopy(48),price:boundedCopy(24)}).strict()).max(8),cta:boundedCopy(24,4).optional()}).strict(),
  StoryChapters: z.object({eyebrow:boundedCopy(40),title:boundedCopy(80,12),chapters:z.array(z.object({eyebrow:boundedCopy(40),title:boundedCopy(80,12),body:boundedCopy(400)}).strict()).max(8)}).strict(),
  ChapterShowcase: z.object({chapter:boundedCopy(40),title:boundedCopy(80,12),pieces:z.array(z.object({tag:boundedCopy(48),name:boundedCopy(80),spec:boundedCopy(48)}).strict()).max(8)}).strict(),
  DispatchHero: z.object({file:boundedCopy(48),chapter:boundedCopy(48),eyebrow:boundedCopy(48),title:boundedCopy(80,12),body:boundedCopy(240),cta:boundedCopy(24,4),call:boundedCopy(24,4),phone:boundedCopy(24,4),trustOpen:boundedCopy(80),trustLicense:boundedCopy(80),coverageLabel:boundedCopy(48),coverageValue:boundedCopy(48),etaLabel:boundedCopy(48),etaValue:boundedCopy(48),areas:z.array(boundedCopy(80)).min(2).max(12)}).strict(),
  ServicesEditorial: z.object({chapter:boundedCopy(48),title:boundedCopy(80,12),services:z.array(z.object({code:boundedCopy(24),title:boundedCopy(80),body:boundedCopy(240),spec:boundedCopy(80)}).strict()).min(1).max(8),cta:boundedCopy(24,4).optional(),asideLabel:boundedCopy(48).optional(),aside:boundedCopy(240).optional(),asideCta:boundedCopy(24,4).optional()}).strict(),
  DispatchTimeline: z.object({chapter:boundedCopy(48),title:boundedCopy(80,12),accent:boundedCopy(40),body:boundedCopy(240),cta:boundedCopy(24,4),call:boundedCopy(40),steps:z.array(z.object({time:boundedCopy(24),title:boundedCopy(80),body:boundedCopy(240)}).strict()).min(1).max(8)}).strict(),
  CrewGrid: z.object({chapter:boundedCopy(48),title:boundedCopy(80,12),body:boundedCopy(240),stats:z.array(z.object({label:boundedCopy(48),value:boundedCopy(24),sub:boundedCopy(80)}).strict()).min(1).max(4),members:z.array(z.object({name:boundedCopy(80),role:boundedCopy(80),years:boundedCopy(24),regions:boundedCopy(120),quote:boundedCopy(240),truck:boundedCopy(48)}).strict()).min(1).max(8),footnote:boundedCopy(160),cta:boundedCopy(24,4)}).strict(),
