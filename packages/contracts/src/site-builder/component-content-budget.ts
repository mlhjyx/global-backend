...
export const QUALIFIED_COMPONENT_CONTENT_BUDGETS = Object.freeze({
  ...
  ProductShowcaseAlt: Object.freeze({ chapter: 40, title: 60, titleWords: 8, accent: 40, intro: 240, code: 24, name: 80, tagline: 80, spec: 48, price: 24, minFeatures: 0, maxFeatures: 3, feature: 80, cta: 24 }),
});
...
const contentSchemas = {
  ...
  AreaGallery: z.object({eyebrow:boundedCopy(40),title:boundedCopy(60,8),accent:boundedCopy(40),areas:z.array(z.object({name:boundedCopy(60),postcodes:boundedCopy(80).optional(),note:boundedCopy(160),alt:boundedCopy(160)}).strict()).min(1).max(8),allCta:boundedCopy(24,4).optional()}).strict(),
  ProjectsGrid: z.object({title:boundedCopy(60,8),items:z.array(z.object({title:boundedCopy(80),description:boundedCopy(240),alt:boundedCopy(160)}).strict()).min(1).max(8),allCta:boundedCopy(24,4).optional()}).strict(),
  MaterialsLibrary: z.object({eyebrow:boundedCopy(40),title:boundedCopy(60,8),accent:boundedCopy(40),intro:boundedCopy(240),items:z.array(z.object({no:boundedCopy(24),name:boundedCopy(80),weight:boundedCopy(48),note:boundedCopy(160),alt:boundedCopy(160)}).strict()).min(1).max(8),primaryCta:boundedCopy(24,4),secondaryCta:boundedCopy(24,4)}).strict(),
  CollectionCards: z.object({eyebrow:boundedCopy(40),title:boundedCopy(60,8),items:z.array(z.object({name:boundedCopy(80),alt:boundedCopy(160)}).strict()).min(1).max(8)}).strict(),
  ProductShowcaseAlt: z.object({chapter:boundedCopy(40),title:boundedCopy(60,8),accent:boundedCopy(40),intro:boundedCopy(240),product:z.object({code:boundedCopy(24),name:boundedCopy(80),tagline:boundedCopy(80),capacity:boundedCopy(48),weight:boundedCopy(48),cycles:boundedCopy(48),price:boundedCopy(24),alt:boundedCopy(160)}).strict(),features:z.array(boundedCopy(80)).max(3),cta:boundedCopy(24,4).optional()}).strict(),
} as const;
