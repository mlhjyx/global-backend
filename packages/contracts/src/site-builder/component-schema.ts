...
export const COMPONENT_SCHEMAS = {
  ...
  AreaGallery: obj({
    ...
    areas: z.array(
      strictObj({
        ...
        noteKey: str,
        asset: strictObj({ assetId: str, altKey: str.optional(), variantUrl: str.regex(/^\/(?!\/)[A-Za-z0-9._~!$&'()*+,;=:@/%-]+$/).optional() }).optional(),
      }),
    ).max(8),
    allLabelKey: str.optional(),
    allPageId: str.optional(),
  ...
  ProjectsGrid: obj({
    titleKey: str,
    items: z.array(strictObj({ titleKey: str, descKey: str, asset: strictObj({ assetId: str, altKey: str.optional(), variantUrl: str.regex(/^\/(?!\/)[A-Za-z0-9._~!$&'()*+,;=:@/%-]+$/).optional() }).optional() })).max(8),
    allLabelKey: str.optional(),
    allPageId: str.optional(),
    variant: technicalBaselineVariant.optional(),
  }),
  ...
  DishesShowcase: obj({
    ...
    titleKey: str,
    titleAccentKey: str,
    dishes: z.array(strictObj({ nameKey: str, seasonKey: str, noteKey: str })).max(8),
  ...
  PhotoGallery: obj({
    ...
    allLabelKey: str.optional(),
    allPageId: str.optional(),
    itemCount: z.number().int().min(1).max(8).optional(),
    items: z.array(strictObj({ assetId: str, altKey: str.optional(), variantUrl: str.regex(/^\/(?!\/)[A-Za-z0-9._~!$&'()*+,;=:@/%-]+$/).optional() })).max(8).optional(),
    variant: technicalBaselineVariant.optional(),
  }),
  MediaCta: obj({
    eyebrowKey: str,
  ...
  CollectionCards: obj({
    eyebrowKey: str,
    titleKey: str,
    items: z.array(strictObj({ nameKey: str, asset: strictObj({ assetId: str, altKey: str.optional(), variantUrl: str.regex(/^\/(?!\/)[A-Za-z0-9._~!$&'()*+,;=:@/%-]+$/).optional() }).optional() })).max(8),
    allPageId: str.optional(),
    variant: technicalBaselineVariant.optional(),
  }),
  DispatchHero: obj({
  ...
  ProductShowcaseAlt: obj({
    ...
    capacityLabelKey: str.optional(),
    weightLabelKey: str.optional(),
    cyclesLabelKey: str.optional(),
    fromLabelKey: str.optional(),
    f1Key: str.optional(),
    f2Key: str.optional(),
    f3Key: str.optional(),
