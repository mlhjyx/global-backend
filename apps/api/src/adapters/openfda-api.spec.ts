...
describe('openFDA registrationlisting 映射（mapRegistration）—— 绿事实法人字段，剥离 🔴 具名个人', () => {
  const sample = {
    ...
    products: [
      { product_code: 'LLZ', created_date: '2011-05-01', openfda: { device_name: 'System, Image Processing, Radiological', device_class: '2', medical_specialty_description: 'Radiology', regulation_number: '892.2050' } },
