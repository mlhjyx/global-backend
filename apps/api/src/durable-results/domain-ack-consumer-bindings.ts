...
export const DOMAIN_ACK_PRODUCT_CONSUMER_BINDINGS = Object.freeze([
  ...
  { producerId: 'discovery.classify_trade_role', consumer: 'WebsiteProfileProvider.classify', domainAggregateType: 'CanonicalCompany', identity: 'company-id-and-operation', resultStrategy: 'typed_projection', resultSchema: 'discovery-classify-trade-role/v1' },
