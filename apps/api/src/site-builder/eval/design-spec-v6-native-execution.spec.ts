...
import { createDesignSpecV6NativeExecutionAttestation } from "./design-spec-v6-native-execution-preflight";

const EXECUTION_ID = "design-spec-native-execution-0001";
const REQUEST_ID = "req_12345678";
const directories: string[] = [];
const v6FeeCardEvidence = Object.freeze(
  JSON.parse(
    readFileSync(
      join(
        __dirname,
...
function attestation(ledgerDirectorySha256: string) {
  ...
  return createDesignSpecV6NativeExecutionAttestation({
    authorization: input.authorization,
    credential: input.credential,
    feeCardEvidence: v6FeeCardEvidence,
  });
}
