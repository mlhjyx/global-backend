...
export const COPY_SONNET_RECOVERY_FIXED_SOURCE_COMMIT =
  "2557b991e62ff171aeec60abff33de2ad8f2859f" as const;
...
export interface CopySonnetRecoveryManifestArtifact {
  ...
  artifactId: "site-builder-copy-sonnet-recovery-manifest-prep/2026-08-09-v14";
...
export function buildCopySonnetRecoveryManifestArtifact(input: {
  ...
  const manifest = Object.freeze({
    ...
    manifestId: "site-builder-copy-sonnet-recovery/2026-08-09-v14" as const,
  ...
  const withoutDigest = {
    ...
    artifactId:
      "site-builder-copy-sonnet-recovery-manifest-prep/2026-08-09-v14" as const,
