...
describe("Copy Sonnet-only recovery create-only manifest", () => {
  it("binds one Sonnet execution to the settlement-fix main and excludes successful wires", () => {
    expect(COPY_SONNET_RECOVERY_FIXED_SOURCE_COMMIT).toBe(
      "2db159ed46f7f7c2acbcf2bb53a8c06d573c8382",
    );
    ...
    expect(artifact).toMatchObject({
      ...
      artifactId:
        "site-builder-copy-sonnet-recovery-manifest-prep/2026-08-08-v12",
      ...
      duplicatePrevention: {
        ...
        acceptedWireReplayPolicy: "never_repeat_successful_v11_wires",
        consumedAuthorizationPolicy: "never_reuse_v11_authorization",
      },
    });
