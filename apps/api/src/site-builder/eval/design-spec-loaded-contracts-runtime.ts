...
const DESIGN_SPEC_LOADED_CONTRACT_EXPORTS = Object.freeze([
  ["DEMO_VISUAL_PACK_V2_SCHEMA_VERSION", DEMO_VISUAL_PACK_V2_SCHEMA_VERSION],
  ...
  ["DESIGN_DNA_SCHEMA_VERSION", DESIGN_DNA_SCHEMA_VERSION],
  ["DESIGN_RULE_SCHEMA_VERSION", DESIGN_RULE_SCHEMA_VERSION],
  [
    "DESIGN_SOURCE_MANIFEST_SCHEMA_VERSION",
    DESIGN_SOURCE_MANIFEST_SCHEMA_VERSION,
  ],
