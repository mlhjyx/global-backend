 ...
 * ② researchBrand 真链路（真 ToolBroker → 真 searxng + 真 crawl4ai；robots 与
 *    R1-safety 双层 egress gate 在工具/adapter/crawler 层强制）
...
async function main(): Promise<void> {
  throw new Error(
    'HISTORICAL_VERIFIER_INCOMPATIBLE: this verifier predates SaaS Budget Grant and is forbidden from dispatching paid product calls',
  );
