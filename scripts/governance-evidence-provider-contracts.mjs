...
> 生命周期：\`CURRENT\`
> 状态：\`CURRENT\`
> 当前事实来源：\`docs/governance/provider-registry.json\` + \`apps/api/src/discovery/provider.registry.ts\`
...
- **SourceClass** is the code-seeded dispatch class or an additional class the adapter explicitly supports.
