#!/bin/bash
# Shared provisioning operation. Only wrappers invoke it; sourcing or executing
# this file alone never starts services. Namespace/schema/credential semantics
# are shared by retained and disposable topologies.
provision_platform_namespace() {
  set -euo pipefail
