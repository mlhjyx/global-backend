module global.local/temporal-platform-server
...
// Temporal v1.31.2 selects thrift v0.23.0, which is rejected by the repository
// dependency review for GHSA-8wv5-x4w7-5gww. The compatible v0.24.0 release is
// used until the upstream Temporal module updates its indirect requirement.
replace github.com/apache/thrift => github.com/apache/thrift v0.24.0

// Temporal v1.31.2 selects grpc-go v1.79.3, which is affected by the xDS/RBAC
// and HTTP/2 advisories GHSA-hrxh-6v49-42gf and GHSA-vp52-pcj8-j9qc. Pin the
// compatible patched release until the upstream module raises its minimum.
