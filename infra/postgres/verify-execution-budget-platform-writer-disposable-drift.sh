...
drift "REVOKE EXECUTE ON FUNCTION revoke_platform_execution_authority_v1(UUID, TEXT, TIMESTAMPTZ) FROM execution_budget_platform_writer" "GRANT EXECUTE ON FUNCTION revoke_platform_execution_authority_v1(UUID, TEXT, TIMESTAMPTZ) TO execution_budget_platform_writer"
