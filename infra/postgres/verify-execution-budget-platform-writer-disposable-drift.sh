...
deny ADMIN "SELECT * FROM inspect_platform_execution_authority_freshness_v1(clock_timestamp())";deny APP "SELECT * FROM inspect_platform_execution_authority_freshness_v1(clock_timestamp())";deny ADMIN "SELECT * FROM revoke_platform_execution_authority_v1('00000000-0000-4000-8000-000000000001','x',clock_timestamp())";deny APP "SELECT * FROM revoke_platform_execution_authority_v1('00000000-0000-4000-8000-000000000001','x',clock_timestamp())";deny ADMIN "SET SESSION AUTHORIZATION runtime_api; SELECT * FROM revoke_platform_execution_authority_v1('00000000-0000-4000-8000-000000000001','x',clock_timestamp())"
drift "REVOKE EXECUTE ON FUNCTION acknowledge_platform_egress_v1(UUID, TEXT) FROM execution_budget_platform_writer" "GRANT EXECUTE ON FUNCTION acknowledge_platform_egress_v1(UUID, TEXT) TO execution_budget_platform_writer"
drift "REVOKE EXECUTE ON FUNCTION inspect_platform_execution_authority_freshness_v1(TIMESTAMPTZ) FROM execution_budget_platform_writer" "GRANT EXECUTE ON FUNCTION inspect_platform_execution_authority_freshness_v1(TIMESTAMPTZ) TO execution_budget_platform_writer"
