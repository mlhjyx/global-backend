...
ok WRITER "SELECT 1 / (has_function_privilege(session_user,'ingest_and_admit_platform_execution_budget_run_v2(TEXT, TEXT, UUID, TEXT, TEXT, execution_budget_purpose, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BIGINT, BIGINT, BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, execution_budget_purpose, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT)'::regprocedure,'EXECUTE')::integer);"
