...
ok WRITER "SELECT 1 / (has_function_privilege(session_user,'acknowledge_platform_egress_v1(UUID, TEXT)'::regprocedure,'EXECUTE')::integer);"
...
ok WRITER "BEGIN; SELECT * FROM ingest_and_admit_platform_execution_budget_run_v2('https://platform-writer-verification.invalid'::text,'global-backend:execution-budget'::text,'10000000-0000-4000-8000-000000000001'::uuid,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'::text,'execution-budget-grant/v1'::text,'platform.acquisition'::execution_budget_purpose,'schedule'::text,'acq-sweep'::text,'acq-sweep'::text,'5e960ccef72129aa32bdd9464c9d7b546e5ed6dd7a639caad46df77edea3448e'::text,'platform-writer-verification'::text,'10000000-0000-4000-8000-000000000001'::text,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'::text,'USD'::text,'microusd'::text,1::bigint,1::bigint,1::bigint,clock_timestamp(),clock_timestamp(),clock_timestamp()+interval '1 minute','platform.acquisition'::execution_budget_purpose,'schedule'::text,'acq-sweep'::text,'acq-sweep'::text,'5e960ccef72129aa32bdd9464c9d7b546e5ed6dd7a639caad46df77edea3448e'::text,'platform-writer-verification'::text,'10000000-0000-4000-8000-000000000001'::text,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'::text); ROLLBACK;"
