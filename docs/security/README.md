...
- `production-dependency-audit-baseline.json` 固定 `origin/main@866ede782579815dd3cd46bcaffb0c1d9626cf46` 的 `pnpm audit --prod` 结果与 canonical finding evidence：10 条 advisory，其中 high 3、moderate 4、low 3、critical 0。
