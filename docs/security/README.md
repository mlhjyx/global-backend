...
- `production-dependency-audit-baseline.json` 当前绑定 `origin/main@a8fedc721bda57ef9d2aeb16a7838a24db4f4a99` 的历史 ratchet 基线与 canonical finding evidence：10 条已登记 advisory，其中 high 3、moderate 4、low 3、critical 0；#506 已将当前 production audit 降为 0 advisory，baseline 仍只保留历史 ratchet 记录。
