...
- `production-dependency-audit-baseline.json` 当前绑定 `origin/main@ec7aa46a520b6ccd3fc6fbe8d7a92970a1725ac2` 的历史 ratchet 基线与 canonical finding evidence：10 条已登记 advisory，其中 high 3、moderate 4、low 3、critical 0；当前主线新增/critical exposure 仍由 advisory canary fail-closed，待安全修复合并后由候选审计证明全部消失。
