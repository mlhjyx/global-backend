...
Phase 4 定义下列语义；Phase 8 已将其落成[机器治理、生命周期与责任规则](../governance/release-and-learning-governance.md)、[可复制模板](../templates/release-bundle-template.md)和[真实 Bundle 索引](../releases/README.md)。当前索引仍为 0，不创建虚假 Release Bundle。每次对用户生效的发布至少包含：
