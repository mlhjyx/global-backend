...
7. 🔄 **待办 3 第二源 · 专利发明人（EPO OPS）**（PR #61，**审批中/未合 main**，见 [decision-maker-p1-epo-ops-inventor-design.md](decision-maker-p1-epo-ops-inventor-design.md)）：applicant 检索近期专利 → 具名 inventor = 技术买家 → 高置信对齐 → **归一名并**（🔴 无 person id → 非 Tier 0，走待办 2 Tier 2/3）。EPO 无消歧 id 故不产 externalIds。CI 绿·真测待 EPO key 审批 → seed 暂 DISABLED。
