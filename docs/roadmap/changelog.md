...
- #356 与 #359 已以 merge commit 进入 `origin/main@2557b991e62ff171aeec60abff33de2ad8f2859f`。v14 [manifest](../evidence/site-builder/m1-g-copy-sonnet-recovery-manifest-v14.json) 以该主线为 fixed source；[runtime binding](../evidence/site-builder/m1-g-copy-sonnet-recovery-runtime-binding-v14.json) 固定后续 TDD 修复提交 `81010e6dba6dcb0652bd8bfd42946678b5347e76`、82-file source digest `bc96878a…`、53-file compiled tree `5e4bd17c…` 与 artifact digest `be2b3a6d…`。
