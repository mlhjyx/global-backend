...
| `docs/design/design-asset-register.md` | MD | 90 行 | `L2_ACTIVE_GOVERNED` | `FULL_READ_RECONCILED + PHASE1_DELTA + IA_APPROVED` | `104f5b19fb785a7cb739a5d6abb432954462aa06dace0298f3ab2ed153d0c4bc` | 活规格/治理；登记 Foundations、13 张 SaaS 代表页、状态/移动端/原型、生成素材和已批准的 8/38 IA Manifest；须与机器事实一致 |
...
| `docs/frontend/02-information-architecture.md` | MD | 130 行 | `L2_ACTIVE_GOVERNED` | `FULL_READ_RECONCILED + IA_8_38_APPROVED` | `c0f2909ec709130509aa873be809b7bfba671682b5005b31250f6674278a7600` | 活规格/治理；Phase 9 已批准 8 个一级/38 个二级 successor，稳定 AREA/PAGE ID 不静默重编号 |
...
| `docs/frontend/05-navigation-and-workspace-shell.md` | MD | 94 行 | `L2_ACTIVE_GOVERNED` | `FULL_READ_RECONCILED + IA_8_38_APPROVED` | `16e45212a3f6f8787479d54339666d3573e7fe88af602e1fe29988fe619d08c1` | 活规格/治理；同步 8/38、7 个 Shell 控件及桌面/平板/移动导航规则 |
...
| `docs/frontend/README.md` | MD | 73 行 | `L2_ACTIVE_GOVERNED` | `FULL_READ_RECONCILED + PHASE9_DELTA + IA_8_38_APPROVED` | `3a950e66c0c13ca8bb5e8bf0234a40be4bbd02ae043e4a22834e1fd192ba93bc` | 活规格/治理；Phase 9 successor 阅读路径和 8/38 导航已同步 |
...
| `docs/roadmap/saas-frontend-phase-9/README.md` | MD | 132 行 | `L3_WORKING_REFERENCE` | `FULL_READ_RECONCILED + PHASE1_DELTA + POST_BASELINE_HASH_REFRESH + IA_APPROVED` | `e912bbb8a483ad062c298013b90c8e12cbdfe86d6b2fbc5a72aac02099f9719f` | 工作/参考；同步 Phase 0/1、76/76 Manifest、13 张 SaaS 代表页（含洞察）和已批准的完整管理员 8/38 IA；不得覆盖 current |
| `docs/roadmap/saas-frontend-phase-9/conflict-and-decision-ledger.md` | MD | 114 行 | `L3_WORKING_REFERENCE` | `FULL_READ_RECONCILED + PHASE1_DELTA + POST_BASELINE_HASH_REFRESH + IA_FIGMA_SYNC` | `bf45646f1e62034f2810b2ddcc5e66d59f0baaf3a73c6a1574065c42b83b457c` | 工作/参考；`DEC-FE-P9-019/020` 已同步核心 Figma，洞察代表页 remediation 已关闭，旧 FigJam 仍标记为过时结构 |
...
| `docs/roadmap/saas-frontend-phase-9/figma-delivery-register.md` | MD | 148 行 | `L3_WORKING_REFERENCE` | `FULL_READ_RECONCILED + PHASE1_DELTA + IA_FIGMA_SYNC` | `be6253c1160c91a7131713e8436d83f962120310dd23d1ae98b81b6ca26e3d59` | 工作/参考；登记 8/38 总图 `44:2`、导航组件 `26:2`、移动抽屉 `53:2`、洞察代表页 `61:2` 和公共首页 7+1 修正；不得覆盖 current |
...
| `docs/roadmap/saas-frontend-phase-9/object-page-family-review.md` | MD | 286 行 | `L3_WORKING_REFERENCE` | `FULL_READ_RECONCILED + IA_APPROVED` | `675d4daba9055f603ba102c8f2aec8b4c09a44e5b2cffa3696cc678a577e811a` | 工作/参考；24 个页面族与已批准 8/38 IA 对齐；候选能力仍按产品状态受控 |
...
| `docs/roadmap/saas-frontend-phase-9/source-and-truth-ledger.md` | MD | 220 行 | `L3_WORKING_REFERENCE` | `FULL_READ_RECONCILED + PHASE1_DELTA + POST_BASELINE_HASH_REFRESH + IA_FIGMA_SYNC` | `314304d740d4e209da7aa319984205f50f100a7e52d2daf3bcf235834443e3f1` | 工作/参考；更新 Figma、洞察代表页 `61:2`、组件资格、MapLocation、`e0e5107` 增量事实和已批准 8/38 IA successor；不得覆盖 current |
...
| 路径 | 类型 | 规模 | 权威层级 | 读取状态 | SHA-256 | 采用规则 |
|---|---:|---:|---|---|---|---|
| `docs/roadmap/saas-frontend-phase-9/design-system-v1-scope.md` | MD | 119 行 | `L3_WORKING_REFERENCE` | `PHASE9_SUCCESSOR_READ + PHASE1_DELTA + POST_BASELINE_HASH_REFRESH` | `fd06c5b40fc6111d32ce78f781f1cc22b2f542529525283c951f2ef379030f1b` | Phase 0 已批准并记录四个 Design 文件、18 张桌面代表（含 13 张 SaaS）、5 个关键状态、3 张移动端和 6 条原型骨架的 Phase 1 草稿；不得冒充已冻结 Token/组件 |
...
| `docs/roadmap/saas-frontend-phase-9/phase-1-design-evidence.md` | MD | 222 行 | `L4_FROZEN_EVIDENCE` | `PHASE9_SUCCESSOR_READ + IA_FIGMA_SYNC_EVIDENCE` | `58f047f1240ae15c8eed96dbb21988e32a77838dff4ba7bd97451e41e7341acc` | Phase 1 Design Node 与作者 QA 证据；已记录 8/38、洞察代表页 `61:2`、移动抽屉、导航组件和公共首页 7+1 修正，不证明用户验证或实现 |
| `docs/roadmap/saas-frontend-phase-9/information-architecture-and-coverage-audit.md` | MD | 287 行 | `L3_WORKING_REFERENCE` | `PHASE9_SUCCESSOR_READ + STRUCTURE_APPROVED + FIGMA_CORE_SYNC` | `e1b5b9d9375b239354542cb927d69fd1efdbb72813dfb1196a7c47174810ecbf` | 8 个一级/38 个二级、7 个 Shell 控件、对象 Tab、76 Page、36 Feature 和 24 Page Family 已获结构批准并完成核心 Figma 同步，含洞察代表页 |
| `docs/roadmap/saas-frontend-phase-9/page-manifest-v2.md` | MD | 167 行 | `L3_WORKING_REFERENCE` | `PHASE9_SUCCESSOR_READ + INSIGHTS_BINDING` | `76f07118ec41aa74e2c24532cb15b5ed0b66d7f7ecbc7f9b872013cda60ded87` | 76 个稳定 Page ID、已设计跨域代表/状态/响应式/六条原型 Node 与公共站候选的 Manifest 2.0 登记；`PAGE-FE-084` 已绑定洞察节点 `61:2`，不改变 current Page Registry 或产品状态 |
