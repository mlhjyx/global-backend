...
| [`release-bundle/v1`](release-bundle.schema.json) | Scope、Promise、Source、Evidence、Operations、Data、Rollback、Guide、Learning，以及相互独立的机器/reviewer/用户授权/merge provenance |
