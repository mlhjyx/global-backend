...
**2026-07-26 首轮完整四模型盲评（只支持 Gold 校准候选判断，不支持晋级）**：完整 create-only campaign 固定在 commit=`c2268b737506ffa6d06391b492d0c09d43962352`、source bundle SHA-256=`720ef1c0f141f53d97c95834ff93bb762368b5a081e5d39c629959b3ba73cd5b`、new-api image digest=`sha256:428018a37c0b26c163a3367c18401161707cd0e08d0f26a3dde9ff0caa05e34c`；四型号均在同一 39 型目录 SHA-256=`1ec192e579dd31a22884ed0d0965bfeeee972fa336dfd58db549248c4eba9b6a` 中，执行前后源码与输入哈希稳定。原交互进程在完成 Gemini/Sonnet/Terra 后收到外部 SIGTERM(143)，其 [interruption.json](../evidence/model-routing/blind-visual-calibration-20260726-alias-fixed-v1/interruption.json) 只保留中断 provenance，不进入模型选择；随后从同一固定提交以 detached service 和全新路径完整重跑，权威汇总为 [campaign-report.json](../evidence/model-routing/blind-visual-calibration-20260726-alias-fixed-v2/campaign-report.json)。
