...
>
> **Copy Sonnet recovery v14 create-only manifest/binding（2026-08-09 当前交付分支，zero-call）**：#356/#359 已以 merge commit 进入 `origin/main@2557b991e62ff171aeec60abff33de2ad8f2859f`，其中 #359 修复 Messages HTTP 200 response validation 的有界脱敏诊断。[`v14 artifact`](../evidence/site-builder/m1-g-copy-sonnet-recovery-manifest-v14.json) 固定该主线、77-file source bundle `3e32bb34…` 与唯一 Sonnet Messages/medium execution（1/2/1）；[`v14 runtime binding`](../evidence/site-builder/m1-g-copy-sonnet-recovery-runtime-binding-v14.json) 再固定 `914a3eed…`、82-file runtime source `ce8546a3…`、53-file compiled tree `97a6a1ec…` 与 binding artifact `4f36a85c…`，并覆盖 canonical binding path 与版本化 manifest/artifact/execution/child-slot 身份和 recovery Git acceptance。Terra/Sol v11 及停止的 v12/v13 Sonnet wire/authorization 均不可复用。两个 artifact 都保持 `NOT_AUTHORIZED`、`dispatchCapable=false`、0 network/model wire 与 0 cost；不含 credential、真实 client 调用或 capability evidence。合并后仍须 post-merge ancestry/compiled 重验、purpose-specific finite credential、settlement/ledger 与用户对单次恢复调用的独立授权；36/72、晋级和路由不在本阶段。
