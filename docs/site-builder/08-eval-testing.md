...
> 当前机器输出只认 [manifest v5](../evidence/site-builder/m1-g-design-spec-evaluation-manifest-v5.json) 及其 [v5 决策卡](../evidence/site-builder/m1-g-design-spec-evaluation-manifest-v5-decision-card.md)；[manifest v1](../evidence/site-builder/m1-g-design-spec-evaluation-manifest-v1.json) 和 [manifest v2](../evidence/site-builder/m1-g-design-spec-evaluation-manifest-v2.json)继续仅供审计。
>
