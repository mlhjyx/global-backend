...
>
> **Copy Sonnet recovery v13 create-only manifest/binding（2026-08-09 当前交付分支，zero-call）**：#355 已以 merge commit `a29b222a45ae5fdb4868d5235cc94aeab1574ecd` 合入 v12 暴露的 cache-only settlement 与脱敏 response-shape durable observation 修复。[`v13 artifact`](../evidence/site-builder/m1-g-copy-sonnet-recovery-manifest-v13.json) 固定该主线、77-file source bundle `c1269c2f…` 与唯一 Sonnet Messages/medium execution（1/2/1）；[`v13 runtime binding`](../evidence/site-builder/m1-g-copy-sonnet-recovery-runtime-binding-v13.json) 再固定 82-file runtime source `5081aa36…`、53-file compiled tree `a7ac0ca8…` 与 binding artifact `f4020ca1…`。Terra/Sol v11 成功 wire及停止的 v12 Sonnet wire/authorization 均不可复用。两个 artifact 都保持 `NOT_AUTHORIZED`、`dispatchCapable=false`、0 network/model wire 与 0 cost；不含 credential、真实 client 调用或 capability evidence。合并后仍须 post-merge ancestry/compiled 重验、purpose-specific finite credential、settlement/ledger 与用户对单次恢复调用的独立授权；36/72、晋级和路由不在本阶段。
>
