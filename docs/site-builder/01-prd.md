...
> 架构详设见 [02-architecture.md](02-architecture.md)。获客侧 2026-07-13 至 2026-08-02 的开发冻结已提前解除，但 M1 收口前不启动其实现；获客任务仍不得并入 Site Builder PR 或争抢未明确分配的共享文件 ownership。
...
- 不因独立站优先而删除 AI 获客代码；M1 收口后获客恢复施工时仍须独立排期、独立 ownership，不与 Site Builder PR 混改共享核心。
