...
- **生产化审计前置（2026-07-24 as-built 复核）**：M0/M1-a/M1-b 的**主干保留**，已确认问题按消费者与正确性分流。truth-sync、R0 contract、**R1-safety ①+②、R2-A1–A4、MF0-A/B、M1-c、R3-A、R3-B1/B2、R4-A1/A2/B-min、M1-d、R1-min、DI-0 与 M1-e-A/B**均已完成。R1-min 的不可变 Release 与 DI-0 合同已由 M1-e-B 真实消费；Catalog 已含六个 approved Family，下一消费者门为 M1-f quality。
...
> **与 §11 生产化审计 PR 的交织（2026-07-24 as-built 复核）**：下表 M1-a…M1-g 是**能力主序列**；R0 contract、R1-safety、R2-A 四项、MF0-A/B、M1-c、R3-A、R3-B1/B2、R4-A1/A2/B-min、M1-d、R1-min、DI-0 与 M1-e-A/B 均已完成。下一步按 M1-f 推进。完整依赖与风险见 §11。
...
| M1-e | 设计主改 | DesignCatalog、6 Family、55 组件、受控组装 |
...
> 来源 v3.2 §4/§9/§15/§16/§19/§20/§21 回写。M1-d 的 ClaimSnapshot/CopyBundle 与 M1-e-B 的 SiteSpec 1.1/DesignBrief/受控组装现已成为 as-built；M1-f quality、SEO/GEO、询盘公开接收与维护任务仍是后续目标。当前真值以代码、§2 触点与 03/04/13/14 专题文档为准。
