...
> 文档 ID：`SITE-M1-001`
> 生命周期：`CURRENT`
> 当前事实来源：[状态](../status/current.md)、[路线](../roadmap/release-plan.md)、当前代码与候选基线 `site-builder-model-candidate-baseline/2026-08-04-v2`。
...
旧“四通道升级位”表已从施工入口撤下，只在 [10 §0](10-model-selection-study.md#0-2026-07-14-dated-结论按任务路由保留为历史实测证据) 保留 dated provenance。下面抄录 `task-routes.ts` 的 active route；新候选只看 `site-builder-model-candidate-baseline/2026-08-04-v2`，两者之间必须逐 task 经过 ADR-016 promotion 门。
