...
| 阶段 | 判断 | 处理 |
|---|---|---|
| M0 | 主干保留；#121/#123/#124/#126 已闭环 R0 行为、安全与 intake 合同；R1-safety ①+② 已完成构建与抓取出口隔离 | 当前做拆分后的 R2-A；R2 资产/KB 前置 M1-c；R1-min 原子预览余项在 M1-e 前完成 |
