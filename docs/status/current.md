...
| 项目                    | 当前事实                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 当前远端主线            | `origin/main@362f88cac1656016bd5aba93032e0f1d90048cba`；2026-08-09 live fetch 核验。该 merge commit 合入 #358 的 CI topology 治理收口，并在祖先链中保留 #356 的 v13 create-only 输入与 #359 的 Anthropic Messages response-compatibility 诊断修复。获客接管的原始代码审计基线仍为 `4562eab1bae16cdd424ff90a7d3403b0fb30d535`；其后主线变化不改变获客实现边界。`/global/backend` 根工作区存在用户现场且不是远端主线真值，不得复位或清理。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 产品阶段                | Site Builder Copy Sonnet recovery v14 正在独立交付分支进行零调用收口：[`v14 manifest`](../evidence/site-builder/m1-g-copy-sonnet-recovery-manifest-v14.json) 固定 #359 merge `2557b991e62ff171aeec60abff33de2ad8f2859f`，只允许 `claude-sonnet-5 / anthropic_messages / medium` 的 1 execution / 最多 2 wires / 最多 1 repair；[`v14 runtime binding`](../evidence/site-builder/m1-g-copy-sonnet-recovery-runtime-binding-v14.json) 进一步固定 canonical path、版本化 manifest/artifact/execution/child-slot 及 campaign/global/child/reservation 身份 namespace、Git evidence acceptance 与 response compatibility compiled bytes。两者均为 `NOT_AUTHORIZED`、`dispatchCapable=false`、零真实调用和零费用。v13 后续私有 operator run 以 2 条 known-settlement wire、1 次 repair、0 completion 停止并冻结，只是诊断观测，不是 tracked capability evidence；其 authorization/wire 永不复用。获客侧处于“受控 pilot 前的治理、授权、运行身份与可观测性补齐”，尚未进入真实 pilot。 |
...
Site Builder Copy 当前在途工作是 #360 的 v14 create-only manifest/runtime binding。它排除 Terra/Sol v11 成功 wire，以及停止的 v12/v13 Sonnet wire/authorization；当前分支不包含真实模型调用、凭据操作、36/72 质量矩阵、晋级或生产路由切换。该 PR 已转 Ready，仍须结清当前 head 的独立 review；只有取得用户单独的 merge-commit 授权、进入主线并完成 post-merge ancestry/compiled 重验后，才可另行准备有限 Sonnet-only 凭据、settlement/ledger 和 exact dispatch authorization。
