...
> 2026-07-10 立；**2026-07-17 R1-safety 与 R2-A1/A2 正确性门更新**。这是当前状态权威；历史见 [../roadmap/changelog.md](../roadmap/changelog.md)。
...
- **当前关键路径**：**R1-safety ①+②与 R2-A1–A4 已完成**；下一项 **MF-0-thin** → **M1-c 纯 Sharp**。R1-min 其余原子预览与 unknown component fail-closed 可并行；MF-0 scanner 前 canonical 不会自动删。
