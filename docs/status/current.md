...
| 项目                    | 当前事实                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 当前远端主线            | 2026-08-13 本地 ref 核对确认 `origin/main@412716a2a78ed6adfd3e605053f3f310651f9777`；它是 #399 的 merge commit，第一父为 #398 route-adoption merge `7f856ce36e0b841ddcda56dc683f38f4856cb9f5`，第二父为 #399 acceptance head `2c9f45b923e738dd0b77d0b4f2ad9c260f516fcc`。本地 `codex/deps-security-remediation` 候选从该 exact main 施工；push/PR/merge 前仍须重新 fetch。`/global/backend` 根工作区存在用户现场且不是远端主线真值，不得复位或清理。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Source-only 质量/安全门 | 当前 main 的仓内 CI 包含 build/typecheck/test、OpenAPI drift/lint/breaking、Gitleaks，以及 #362 新增的 production dependency audit ratchet、Dependency Review 与 CodeQL canary；后两者仍是 non-required canary，container/Compose/IaC、PostgreSQL/Temporal 集成与恢复演练也尚未形成完整 required gate。2026-08-09 main 基线 lock（SHA-256 `d98a61553ffa6ea3bca177f47c7c2a82362f774697ffd4c89fa299465072e868`）的 production audit 为 36 项（18 high、14 moderate、4 low、0 critical）。本地 `codex/deps-security-remediation` 候选从 `origin/main@412716a2…` 以 TDD 将官方 production-only audit 收敛为 0 项（0 critical/high/moderate/low；839 production dependencies），实现 checkpoint 为 `06116e377407c90e3e7fe078980b61ab3e6ab42d`，并把完整 API coverage 改为真实 `src/**/*.ts` inventory；复审后 parser 行为测试也改为沿当前 Nest→Express 生产图解析，workflow 主动写入的 fail-safe result/error evidence 字段只保留闭合机器码。该证明不覆盖 Temporal activity failure event 或 terminal rethrow history。它尚未 push/PR/hosted CI/合并；statements/branches coverage 与 Copy fixed-source 门仍 HOLD。完整边界见 [dependency security TDD 记录](../implementation-records/dependency-security-remediation-tdd.md)。 |
...
6. **覆盖率门**：本地全量 API 为 4902 PASS / 2 skipped；完整 `src/**/*.ts` inventory 为 statements 78.39%、branches 73.42%、functions 81.53%、lines 80.23%。statements/branches 未达到项目 80% 门，本候选继续 HOLD。
