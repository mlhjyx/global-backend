...
> **2026-08-11 Copy Sonnet recovery 当前状态**：`origin/main@8a3cf586ad8a9e86fe49c753b408a043b70feca6` 已包含 #391 的 v20 successor 合同。已获授权的单次 v20 **零调用** preflight 在 clean main 实际执行：ToolBroker 成功读取 OpenOx public pricing source（0 model cost、2975ms），随后 token #27 的 bearer `/v1/models` inventory readback 收到安全记录的 HTTP 403，正式 writer 在读取响应体前 fail closed 并 cleanup。脱敏事实见 [`v20 stopped evidence`](../evidence/site-builder/m1-g-copy-sonnet-recovery-v20-zero-call-preflight-stopped-evidence.json)：route #20、v16 #24、v17 #25、v19 #26 与 v20 #27 均为 disabled；不存在成功 artifact、模型 dispatch request、模型 wire 或模型费用。v20 授权已消费，不得重试或创建 successor；模型 dispatch 仍需新的明确授权。

## 1. 当前基线

| 项目                    | 当前事实                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 当前远端主线            | 2026-08-11 live fetch 已确认 `origin/main@8a3cf586ad8a9e86fe49c753b408a043b70feca6` 为 #391 merge commit，first-parent 已含 #385/#386 的 v18 stop chain、#387 v19 successor 合同、#388 v19 stopped evidence、#389 endpoint-safe preflight failure diagnosis 与 #391 v20 successor 合同。#378 的 v16 fixed-source rebase 是其历史前置，不能再作为 current main 或“未执行 preflight”的操作依据。精确远端 tip 属易漂移外部状态，push/PR/merge/preflight 前仍须重新 fetch。`/global/backend` 根工作区存在用户现场且不是远端主线真值，不得复位或清理。 |
| 产品阶段                | Site Builder Copy Sonnet recovery 保持 `NOT_AUTHORIZED / BLOCKED`，不是 capability evidence。v16 #24、v17 #25、v19 #26 与 v20 #27 是 disabled 的不可复用失败审计记录；v18 没有 token 且其 stopped evidence 不可改写。v20 已在 post-create bearer model-inventory readback 403 fail closed，成功 artifact 不存在；没有部署、fresh RuntimeEvidence、Release Bundle 或真实 pilot。 |
