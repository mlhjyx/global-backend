...
> 2026-07-10 立；**2026-07-17 R1-safety、R2-A1–A4 与 MF0-A/B 更新**。这是当前状态权威；历史见 [../roadmap/changelog.md](../roadmap/changelog.md)。
...
- **当前关键路径**：**R1-safety ①+②、R2-A1–A4 与 MF0-A/B 已完成**；下一项是 **M1-c 纯 Sharp**。R1-min 其余原子预览与 unknown component fail-closed 可并行。
