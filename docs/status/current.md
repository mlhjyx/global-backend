...
6. **覆盖率门**：本地全量 API 为 4901 PASS / 2 skipped；完整 `src/**/*.ts` inventory 为 statements 78.40%、branches 73.43%、functions 81.53%、lines 80.24%。statements/branches 未达到项目 80% 门，本候选继续 HOLD。
