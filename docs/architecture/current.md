...
- 当前关键路径：**M1-d**。R4-A2 已关闭内部 Claim/Evidence truth bridge，R4-B-min 已关闭 BrandProfile 整体重试幂等和持久成本真值；正式 Copy/locale/SiteSpec 消费仍属 M1-d。R1-min 的生产 Release 边界仍须在 M1-e 可见预览前完成。
